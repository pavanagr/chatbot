...
startsearch_response_dict = {
    "pune":'<Here is a list of top 5 startups in Delhi based on the funding amount: <UL><li>Snapdeal</li><li>Hike</li><li>Oyo</li><li>Delhivery</li><li>OyoRooms</li></ul>For more info: <a href=\"http://www.github.com/lkamat\">Startups in Mumbai</a>',
...
startupinfo_response_dict = {
    ...
    "cities": 'Top 5 cities with the most startup funding:<UL><li>Bangalore</li><li>Mumbai</li><li>New Delhi</li><li>Gurgaon</li><li>Pune</li></ul>For more info: <a href="http://www.github.com/lkamat">Startups in India</a>',
...
brand_search_response_dict = {
	"eventtracker":'Eventtracker is a SIEM tool.',
	"faq_link":'You can check out the list of startups here <a href="http://www.github.com/lkamat">Startups in India</a>'
}
...
GREETING_RESPONSES = ["sup brsdo", "hesdfdsy", "*nsdods*", "how sdsacan i help?", "what asdsakind of food are you craving for today","<h1>hello</h1>"]
...
def brand_search(entities):
    if entities == []:
        return "Could not find out specific information about this ..." +  brand_search_response_dict["faq_link"]
    if len(entities) >= 1:
        return brand_search_response_dict[entities[0]['value']]
    return "Sorry.." + brand_search_response_dict["faq_link"]

def integration_search(entities):
    if entities == []:
        return "Could not find out specific information about this ..." +  integration_response_dict["faq_link"]
    if len(entities) >= 1:
        return integration_response_dict[entities[0]['value']]
    return "Sorry.." + integration_response_dict["faq_link"]
